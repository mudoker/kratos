  ...
  return (
    <div className="flex flex-col h-full justify-between items-center lg:group-hover:items-stretch">
      <div className={cn("w-full flex flex-col items-center lg:group-hover:items-stretch", isMobile ? "space-y-3" : "space-y-5")}>
        ...
        <div className={cn(
          ...
          <div className="relative z-10 flex flex-col items-center lg:group-hover:items-stretch">
            <div className={cn("flex items-center justify-center lg:group-hover:justify-start w-full", isMobile ? "gap-2" : "gap-0 lg:group-hover:gap-2")}>
              <div className="h-5 w-5 rounded bg-background/10 text-background flex items-center justify-center shrink-0">
                <Dumbbell className="h-3 w-3" />
              </div>
              <span className={cn(
                "text-[9px] font-extrabold uppercase tracking-widest text-background/75 transition-all duration-200 inline-block",
                !isMobile 
        ...
        {/* Athlete User info */}
        <div className={cn(
          "border border-border bg-card flex items-center transition-all duration-200",
          isMobile 
            ? "p-3 rounded-xl w-full" 
        ...
        <nav className="flex flex-col items-center lg:group-hover:items-stretch gap-1 w-full">
          {items.map((item) => {
            ...
            return (
              ...
              >
                <Icon className={cn("h-4.5 w-4.5 shrink-0 transition-colors", isActive ? "text-foreground" : "text-muted-foreground")} />
                <span className={cn(
